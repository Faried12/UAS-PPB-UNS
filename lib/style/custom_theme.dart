...
class CustomTheme {
  static ThemeData lightTheme = ThemeData(
      ...
      primaryIconTheme: const IconThemeData(color: Colors.black87), colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.grey).copyWith(background: const Color(0xFF040404)));
